...
final class WebSocketController {
    ...
    func handleConnection(_ req: Request, client: WebSocket) {
        ...
        client.onBinary { [weak self] client, data in
            self?.handleRequest(client: client, data: data)
        }
    ...
    private func handleRequest(client: WebSocket, data: ByteBuffer) {
        ...
        case .createRoom:
            handleCreateRoom(client: client, data: data)
        case .joinRoom:
            handleJoinRoom(client: client, data: data)
        }
    }
    ...
    private func handleCreateRoom(client: WebSocket, data: ByteBuffer) {
    ...
    private func handleJoinRoom(client: WebSocket, data: ByteBuffer) {
