...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        let webRTCClient = WebRTCClientImpl(
            iceServers: [
        ...
        let watingRoomViewController = WaitingRoomViewController(connectionClient: connectionClient)
        let navigationController = UINavigationController(rootViewController: watingRoomViewController)
